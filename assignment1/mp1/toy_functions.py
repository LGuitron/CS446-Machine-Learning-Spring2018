...
def toy_fn_3(arg1, arg2):
    ...
    '''
    # Input your code here
    # Join tensors in rank-2 tensor
    tensor2d = tf.concat([[arg1], [arg2]], 0)
    # Transpose matrix
    tensor2d = tf.transpose(tensor2d)
    # Reshape result to rank-1 tensor
    tensor2d = tf.reshape(tensor2d, [-1])
    return tensor2d
