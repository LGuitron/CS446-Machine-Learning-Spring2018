...
flags.DEFINE_integer('n_components', 100 , 'Number of components')
...
def main(_):
    ...
    """
    # Load dataset.
    _, unlabeled_data = io_tools.read_dataset('data/mnist_test.csv')
    ...
    # Supervised training.
    train_label, train_data = io_tools.read_dataset('data/mnist_test.csv')
